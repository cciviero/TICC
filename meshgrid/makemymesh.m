...
% Execute manually.
%
% This program allows the user to specify parameters for and run
% generating code that produces irregular tetrahedral meshes.
%
...
%% cd /raid/AmplitudeProjects/testdistmesh
...
% fstatlist = '/raid/Private/sigloch/fftomography/dataruns/test/writeraydata.stationfile';
%% fstatlist = '/raid/Private/sigloch/fftomography/dataruns/test/writeraydata.stationfile.short';% short



meshname = 'USA3';   % 82803 vertices, densified down to 
hmatrix_mode = 'stationdensified';
fstatlist = 'writeraydata.stationfile.ttimes.USA789';
sig = 200;  % was same for USA2

meshname = 'USA4';   % 98046 vertices
hmatrix_mode = 'stationdensified';
fstatlist = 'writeraydata.stationfile.ttimes.USA789';
sig = 300;

% hmatrix_mode = 'kerneldensified'; % currently disabled
%---------------------------------

meshname = 'USA5'; % 84884 nodes 
hmatrix_mode = 'stationdensified';
fstatlist = 'writeraydata.stationfile.ttimes.USA789';
% no sig, uses linear densification instead

% LINEAR DENSIFICATION -- produces more evenly spaced grids
meshname = 'USA10'; % 92175 -- very nice grid
hmatrix_mode = 'stationdensified';
fstatlist = 'writeraydata.stationfile.ttimes.USA789';
% no sig, uses linear densification instead
% parameters:
...
meshname = 'G10'; % 212815 vertices, looks good
hmatrix_mode = 'stationdensified';
% fstatlist = 'writeraydata.stationfile.ttimes.G10T';
fstatlist = 'writeraydata.stationfile.ttimes.G10T.plusSAMPLEandPLUME';
 

% G11: same as G10 but highest density less dense (min facets only 100 km long)
meshname = 'G11';  % 160430
hmatrix_mode = 'stationdensified';
fstatlist = 'writeraydata.stationfile.ttimes.G10T.plusSAMPLEandPLUME';
% from G10 to G11, changed just one line (min facet length):
% WAS: hval0 =  66; IS: hval0 =  100;  



%========  END: SET/CHECK PARAMETERS  ===============

basedir = '/raid/Private/sigloch/testdistmesh/'
...
distmeshpath = '/data/jingjie/sigloch/INVERSION/Programs/meshing_distmesh/distmesh';
% distmeshpath = '/home2/sigloch/SoftwareUsed/Matlab_FreeLicense/DistMesh_Automatic3d_Tetrahedral_Meshes/distmesh';
...
d=inline(expr,'p');
% pfix = [0 0 0]; % fixed points (Earth's center for USA2)
pfix = [];  % fixed points
...
d1 = 0;    h1 = 200;
%% d1 = 0;    h1 = 100;  % first try, works
d2 = 900;  h2 = 200;   % for USA5
% d2 = 900;  h2 = 200;   % for USA5, and R=1000 -- lin densi
% d2 = 900;  h2 = 200;   % for USA3 and USA4
% d2 = 670;  h2 = 200; % was used for USA2
d3 = 2889; h3 = 600;
