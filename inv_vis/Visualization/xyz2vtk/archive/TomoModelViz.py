...
# ---------------- INPUTS
#tomo_file = '../models/kasra_june_2016/solx.02.dlnVp.iter4'
#tomo_file = '../models/maria_aug_2016/homo_400_rhum_rum_P_PP_v0102/solx.07.dlnVp.homo_400'
...
if "1" in cut_type:
    ...
    m.pcolormesh(hlons_grd, hlats_grd, reshape_interpolate.T - reshape_mean,
                 latlon=True, zorder=10, cmap=plt.cm.seismic_r,
                 vmin=vmin, vmax=vmax)
    ...
    while True:
        ...
        if 'n' in onscreen.lower():
            ...
            print '.....'
            ncuts = plt.ginput(n=2, timeout=-10, show_clicks=True)
            print 'fucking select something... '
            ...
            if 'poles' in plot_mode:
                ...
                if map_sel == '3':
                    ...
                    max_lon_v, max_lat_v = m3(ncuts[1][0], ncuts[1][1],
                                              inverse=True)
        print 'you reached at least a save place...'
        print min_lon_v, min_lat_v, max_lon_v, max_lat_v
        ...
        print 'What the fuck takes so long??'
