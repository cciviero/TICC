...
!      parameter(MMAX=200000,NMAX=2000000,NDIM=200000)
      ...
      character*256 fname
      character*256 ident,ident2,ident3
...
161   read(2,*,iostat=ios) kssw
      ...
      print *
      print *,'Other:'
      print *,'11=generate dT values from user-provided model'

      print *,'Give test option:'
      read *,koption
      write(4,*) 'Test option used: ',koption
      ...
      ! smaller than the pulse spacing; else cancellation of several pulses
        ...
        do while(r.ge.r1)
          ...
          do while(rcolat.le.rcolat2)
            if (rcolat.lt.(10.*onedr)) then
                drlon = drlon_input*4.
            else if (rcolat.lt.(20.*onedr)) then
                drlon = drlon_input*2.
            else if (rcolat.gt.(150.*onedr)) then
                write(*,*) rcolat
                drlon = drlon_input*4.
            else if (rcolat.gt.(160.*onedr)) then
                drlon = drlon_input*2.
            else
                drlon = drlon_input
            end if
...
300       continue
      ...
      ! Isolated Plumes, having a 2-D Gaussian as cross-section.
