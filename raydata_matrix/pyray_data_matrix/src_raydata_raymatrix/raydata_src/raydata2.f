      ! compile: g77 raydata2.f raytracesubs2.f azdel.f
      ...
      dimension rcr2(16),vcr2(16), ecr2(16)                               ! CRUST2.0
...
c    &      form='formatted')
     ...
     & ' deviates from 6371 - crustal corrections are not OK'
      ...
      write(6,*) 'Now processing data data for CRUST2.0:'
c     write(6,fmt='(i8," to ",i8,2x,a26)') ndata,ndata+100,ctime(itm)
      print  *, 'src.shallow.'//dataf
...
c      write(6,*) 'reading idate=',
c     &     idate,', ievt=',
c     &     ievt,', station: ', stationcode, netw
      if(ios.ne.0) then
