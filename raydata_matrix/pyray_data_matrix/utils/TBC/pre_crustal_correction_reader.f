...
c read in types: not necessary for computations
      open(55,file='CNtype1-1.txt')
      do j=1,nla
         read(55,101)(ctypes(j,i),i=1,360)
 101  format(360(1x,a2))
      enddo    
      close(55) 
...
c make sure longitudes go from -180 to 180
      ...
      ilat=90.-flat+1
      ilon=180.+flon+1
      print 102,'ilat,ilon,crustal type: ',ilat,ilon,ctypes(ilat,ilon)
 102  format(a,2i4,2x,a2)
