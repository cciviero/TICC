...
plt.figure()
plt.subplot(2, 1, 1)
plt.scatter(res[:, 3].astype(float),
            res[:, 8].astype(float), c='r', edgecolors='none',
            alpha=alpha_plt)
...
plt.vlines(50.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)),
           'k', linestyles='-')
plt.vlines(26.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)),
           'k', linestyles='-')
plt.vlines(60.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)),
           'k', linestyles='-')
plt.vlines(34.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)),
           'k', linestyles='-')

plt.subplot(2, 1, 2)
plt.scatter(res[:, 4].astype(float),
            res[:, 8].astype(float), c='r', edgecolors='none',
            alpha=alpha_plt)
...
plt.vlines(-127.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)), 'k', linestyles='-')
plt.vlines(-60.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)), 'k', linestyles='-')
plt.vlines(-12.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)), 'k', linestyles='dotted')
plt.vlines(41.0, min(res[:, 8].astype(float)),
           max(res[:, 8].astype(float)), 'k', linestyles='dotted')
...
plt.figure()
plt.subplot(2, 1, 1)
plt.scatter(res[:, 12].astype(float),
            res[:, 14].astype(float) - res[:, 13].astype(float),
            c='r', edgecolors='none',
            alpha=alpha_plt)
...
plt.figure()
plt.scatter(res[:, 12].astype(float),
            res[:, 16].astype(float) - res[:, 13].astype(float),
            c='r', edgecolors='none',
            alpha=alpha_plt)
plt.xlabel('Epicentral distance', size='large', weight='bold')
...
plt.figure()
plt.scatter(res[:, 12].astype(float),
            res[:, 14].astype(float) - np.array(taup_time).astype(float),
            c='r', edgecolors='none',
            alpha=alpha_plt)
plt.xlabel('Epicentral distance', size='large', weight='bold')
...
plt.figure()
plt.scatter(res[:, 12].astype(float),
            abs(res[:, 14].astype(float) -
                np.array(taup_time).astype(float)) /
            np.array(taup_time).astype(float) * 100,
            c='r', edgecolors='none',
            alpha=alpha_plt)
plt.xlabel('Epicentral distance', size='large', weight='bold')
