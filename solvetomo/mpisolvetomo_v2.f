...
c whereas ksmooth=1 seems to work fine by now.
      ...
      read(5,*) yt0,yt1,yt2,yt3,yt4,yt5,
     & yt6,yt7,yt8,yt9,yt10
 
       print *, 'Read ytry values are:'
       ! XXX>>> MT'18: I don't understand why I need to first print these values
       ! and then I also need to print a ytry_dummy value?! Otherwise I
       ! get a problem with colvalue in line ~266: do i=1,nrden <<<XXX
       print *, yt0,yt1,yt2,yt3,yt4,yt5
       print *, yt6,yt7,yt8,yt9,yt10,ytry_dummy
       ! read ytry from input in.st into data declaration
       ytry_lcurve = reshape([yt0,yt1,yt2,yt3,yt4,yt5,
     & yt6,yt7,yt8,yt9,yt10], [11])
